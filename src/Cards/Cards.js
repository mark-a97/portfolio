        ...
        this.state = {
            cardDetails: [
                ...
                },
                {
                    ...
                    linkProject: "https://mark-a97.github.io/weather-api/",
                    linkGit: "https://github.com/mark-a97/weather-api/tree/gh-pages/src",
                    classType: "btn btn-success btn-margin",
                    projectInfo: "Connecting to the WeatherAPI and showing a 3 day weather forecast",
                     year: '2021',
                },
                {
                    id: 3,
                ...
                <Container fluid className="d-flex justify-content-center mb-5 ">
                    <Row lg={3} md={2}xs={1}>
                        {this.props.type === "done" ? this.state.cardDetails.map((card) => (
                            ...
                            <Col className="md-4 text-left" md={12} lg={12} key={card.id}>
                                <Card 
                                    title={card.title}
                                    desc={card.desc}
                                    info={card.projectInfo}
